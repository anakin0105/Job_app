...
"""Точка входа в приложение — главное меню проекта.

Объединяет два режима:
- JSON-режим (работа с избранным)
- PostgreSQL-режим (курсовая по БД)
"""
...
def json_mode() -> None:
    """Запускает режим работы с JSON-избранным (первая часть курсовой)."""
...
def db_mode() -> None:
    """Запускает режим работы с PostgreSQL (вторая часть курсовой)."""
...
def main():
    """Главная функция приложения. Запускает приветствие и главное меню."""
